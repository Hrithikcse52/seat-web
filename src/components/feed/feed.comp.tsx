    ...
    <div className="flex w-full">
      <div className="flex flex-col flex-grow  border-r border-gray-300">
        <div className="flex justify-between flex-shrink-0 px-8 py-4 border-b border-gray-300">
          ...
          <button type="button" className="flex items-center h-8 px-2 text-sm bg-gray-300 rounded-sm hover:bg-gray-400">
            New post
          </button>
        </div>
          ...
          <div className="flex w-full p-8 border-b-4 border-gray-300">
            ...
            <div className="flex flex-col flex-grow ml-4">
              ...
              <div className="flex justify-between mt-2">
                <button type="button" className="flex items-center h-8 px-3 text-xs rounded-sm hover:bg-gray-200">
                  Attach
                </button>
                <button
                  type="button"
