...
export default function ScrollFeed() {
  ...
  async function handleReaction(action: "like" | "comment", postId: string, index: number, message = "") {
    try {
      // if (action === "like") {
      //   const idx = posts?.[index].likes.findIndex(id => id._id === user?._id);
    ...
    <div className="flex flex-col flex-grow  border-r border-gray-300">
      ...
      <div className="no-scrollbar flex-grow h-0 overflow-auto">
              ...
              <div className="flex flex-col flex-grow ml-4">
                ...
                <div className="mt-4 w-full flex items-center justify-between">
                  <div className="flex items-center">
                    <button name="like" type="button" className="flex items-center group mr-8">
                    ...
                    <button name="comment" type="button" className="flex items-center group ">
        ...
        {isPostFetched &&
          posts &&
          posts.map((post, idx) => {
            const like = isPostLiked(user && user._id, post);
            const likeColor = like ? "blue" : "currentColor";
            return (
                  ...
                  <div className="mt-4 w-full flex items-center justify-between">
                    <div className="flex items-center">
                      <button
                        type="button"
                        onClick={() => {
                          if (!like) handleReaction("like", post._id, idx);
                        }}
