        ...
        <div className="md:mt-24 f-f-p">
            ...
            <div className="flex flex-col items-center md:items-end md:pr-12 md:border-r-4 border-gray-300 relative md:w-1/2">
              <div aria-label="sign up" role="img">
                <Image
                  width="100%"
                  height="100%"
                  className="w-full h-full focus:outline-none mt-10"
              ...
              <div aria-label="2" role="img">
                <Image
                  width="100%"
                  height="100%"
                  className="focus:outline-none mt-24 w-full h-full"
              ...
              <Image
                width="100%"
                height="100%"
                className="hidden md:block absolute right-0 top-0 -mt-2 -mr-1 w-full h-full"
            ...
            <div className="flex flex-col items-center md:items-start md:pl-12 lg:border-gray-400 mt-20 md:mt-0 md:w-1/2">
              ...
              <div aria-label="wallet" role="img">
                <Image
                  width="100%"
                  height="100%"
                  className="focus:outline-none mt-32 w-full h-full"
              ...
              <div aria-label="3" role="img">
                <Image
                  width="100%"
                  height="100%"
                  className="focus:outline-none mt-20 w-full h-full"
          ...
          <div className="md:hidden flex flex-col items-center w-full">
            <Image
              width="100%"
              height="100%"
              className="focus:outline-none my-10 w-full h-full"
              src="https://tuk-cdn.s3.amazonaws.com/can-uploader/3_step_center_aligned_how_it_worksSvg1.svg"
              alt=""
            />
            <Image
